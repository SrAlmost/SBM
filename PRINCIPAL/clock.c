...
/*----------------- DECLARACION FUNCIONES ----------------------------*/
	...
	/*----------------- TIMER ----------------------------*/
/**
 * @brief Inicializa el timer periodico para gestionar las variables globales: segundos, minutos y horas
 *
 * @return Devuelve -1 si ha ocurrido algun error o 0 si todo ha funcionado correctamente
*/
static int8_t Init_Timer(void);

/**
 * @brief Actualiza las variables: segundo, minutos y horas; cuando salta la interrupci�n del timer (cada 1 s) 
 *
*/
static void Timer_Callback (void);
	...
	/*----------------- HILO ----------------------------*/
/**
 * @brief Funcion que gestionar� el hilo del Clock
 *
 * @param Dato arbitrario que se le pasa a la funcion osThreadNew  
*/
