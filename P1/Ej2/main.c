...
int main(void)
{
  ...
  SystemCoreClockUpdate();
	...
	//Inicialización LD1 -> Verde
	InitLeds(GPIO_PIN_0);
	//Inicialización LD2 -> Azul
	InitLeds(GPIO_PIN_7);
	//Inicialización LD3 -> Rojo
	InitLeds(GPIO_PIN_14);
...
static void SystemClock_Config(void)
{
  ...
  /* The voltage scaling allows optimizing the power consumption when the device is 
     clocked below the maximum system periodouency, to update the voltage scaling value 
     regarding system periodouency refer to product datasheet.  */
...
/**
  * @brief  Inicializa los pines de los leds para poder usarlos
  * @param  Pin del led que se va a configurar
  * @retval None
  */
void InitLeds(uint16_t GPIO_Pin){
