...
static void programacion(){
	...
	osMessageQueuePut(mid_MsgQueueLCD, &infoReposo, 0U, 0U);
	infoReposo.linea = 2;
	sprintf(infoReposo.inf, "   H:%d%d:%d%d:%d%d---Tr:%0.1f", horasMod/10, horasMod%10, minutosMod/10, minutosMod%10, segundosMod/10, segundosMod%10, temRefMod);
	osMessageQueuePut(mid_MsgQueueLCD, &infoReposo, 0U, 0U);
	osMessageQueueGet(mid_MsgQueueJOY,&pulsacion, NULL, 0U);
			...
			case ARRIBA:
				switch(varMod)
				{
					...
					case 0x04:
						...
						break;
					case 0x02:
						temRefMod = (temRefMod > 20) ? (temRefMod - 20) : (temRefMod + 10);
						break;
					case 0x01:
						temRefMod = (temRefMod == 30) ? 5 : (temRefMod + 1);
						break;
				}
				pulsacion.direccion = 0x00;
				break;
			case ABAJO:
				switch(varMod)
				{
					...
					case 0x04:
						...
						break;
					case 0x02:
						temRefMod = (temRefMod < 10) ? (temRefMod + 20) : (temRefMod - 10);
						break;
					case 0x01:
						temRefMod = (temRefMod == 5) ? 30 : (temRefMod - 1);
						break;
				}
				pulsacion.direccion = 0x00;
				break;
